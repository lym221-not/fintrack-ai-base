  ...
  const generateCode = async () => {
    ...
    try {
      ...
      toast({
        ...
        description: "Your Telegram link code is valid for 15 minutes.",
      });
    } catch (error: any) {
      toast({
      ...
      <Card className="mb-6">
        <CardContent className="p-6">
          ...
          <div className="space-y-4">
            <div>
              <label className="text-[10px] font-semibold uppercase tracking-[0.15em] text-muted-foreground mb-1.5 block">Name</label>
              <Input
                value={name}
            ...
            <div>
              <label className="text-[10px] font-semibold uppercase tracking-[0.15em] text-muted-foreground mb-1.5 block">Email</label>
              <Input
                type="email"
                value={email}
                disabled
